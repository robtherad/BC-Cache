...
switch (_char) do {
 ...
 case "O_Soldier_lite_F": {[] call compile preprocessFileLineNumbers "f\loadout\units\Red_MGTL.sqf"};
 ...
 case "B_Soldier_SL_F": {[] call compile preprocessFileLineNumbers "f\loadout\units\Blue_PLSL.sqf"};
 ...
 case "B_Soldier_lite_F": {[] call compile preprocessFileLineNumbers "f\loadout\units\Blue_MGTL.sqf"};
 ...
 case "B_crew_F": {[] call compile preprocessFileLineNumbers "f\loadout\units\Blue_CREW.sqf"};
 case "B_Pilot_F": {[] call compile preprocessFileLineNumbers "f\loadout\units\Blue_PILOT.sqf"};
};
